class GetClientAddressModel {
  bool? status;
  List<Data>? data;
  String? message;
  String? requestId;

  GetClientAddressModel({this.status, this.data, this.message, this.requestId});

  GetClientAddressModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
